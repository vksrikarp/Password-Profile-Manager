...
import random
class PersonalAccountManager(Innomatics): ##used

    @classmethod
    def login(cls,username, password): ##used
        validity = False
        for i in cls.Users["Users"]:
    ...
    def user_registration(self): ##used
        name = input("Enter name::")
    ...
    def changePassword(self, username): #used
...
class ProfileManagement(PersonalAccountManager):
    ...
    def setName(self,username): #used
    ...
    def setUsername(self,username): #used
    ...
    def setCourse_Enrolled(self,username): ##used

        new_course_enrolled = input(f"{username}, Edit Course Name::")
    ...
    def setEmail(self,username): ##used
    ...
    def setPhoneNumber(self,username):  ##used
    ...
    def setAddress(self,username):  ##used
         # = self.username
